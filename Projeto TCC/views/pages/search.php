...
<html lang="en" class="h-100">
    ...
    <body class="d-flex h-100 text-center text-bg-dark">
        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            <?php view("includes.navbar", ["page" => "search"]); ?> <!-- Inclui o cabeçalho pelo arquivo navbar.php -->
            ...
            <main class="px-3 h-100 d-inline-flex align-items-center">
                <div class="w-100">
                    ...
                    <div class="container">
                        <form method="GET" action="/results"> <!-- Formulário de pesquisa simples, enviado à página de resultados em results.php pelo método GET -->
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12">
                                    <div class="d-inline-flex align-items-center">
                                        <input class="btn btn-primary me-1" type="submit" value="Pesquisar"> <!-- Direciona a advanced_search.php -->
